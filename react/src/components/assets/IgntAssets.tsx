  ...
  return (
    <section className={className ?? ""}>
      <header className="flex items-center justify-between">
        <h2 className="text-3xl custom-active-link-class font-semibold p-0 m-0 mb-2.5 flex-1">Tokenized Assets</h2>
      ...
      {(!address || (!balances.isLoading && !balances.assets.length)) && (
        <div className="text-left text-black opacity-75 text-md font-normal py-8">You have no tokenized assets</div>
      )}
